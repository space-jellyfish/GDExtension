...
int main(void) {
	...
	std::vector<std::vector<int>> level = {{17, 17, 31, 17, 17}, {17, 17, 18, 17, 17}, {17, 17, 17, 17, 17}, {17, 17, 17, 17, 17}, {64, 64, 31, 64, 64}};

	std::tuple<int, int> start(2, 4);
	std::tuple<int, int> end(2, 0);
	Pathfinder p;
